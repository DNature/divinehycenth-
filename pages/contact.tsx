      ...
      <div className="block lg:grid grid-cols-6 gap-6 grid-rows-2 xl:px-40 lg:px-32">
        <div className="card-contact shadow rounded-lg col-span-3 row-span-6 p-5 row-span-1 row-end-3">
          ...
          <form data-netlify="true">
            <div className="my-8">
              <input type="text" className="p-6 bg-g-15 rounded-sm w-full outline-none" placeholder="Full Name" autoFocus />
            </div>
            <div className="my-8">
              <input type="text" className="p-6 bg-g-15 rounded-sm w-full outline-none" placeholder="Full Name" />
            </div>
            <div className="my-8">
              <textarea className="p-6 bg-g-15 rounded-sm w-full h-40 outline-none resize-none" placeholder="How can i help?..." />
            </div>
