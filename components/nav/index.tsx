    ...
    <>
      <div className={`py-4 justify-center z-20 fixed top-0 left-0 w-full hidden sm:flex ${navBackground && "gradient shadow"}`}>
        <nav className="flex content-center ">
          <CustomLink href="/" className="my-auto">
            <img src="/images/logo.svg" alt="Logo" className={`${navBackground ? "w-8 h-8" : "w-12 h-12"} mr-10  transition-all duration-200`} />
          </CustomLink>
      ...
      <div className={`z-20 fixed top-0 left-0 w-full py-0 flex flex-col sm:hidden ${navBackground && "gradient shadow"}`}>
        <div className="flex justify-between p-4">
          <CustomLink href="/">
            <img src="/images/logo.svg" alt="Logo" className={`${navBackground ? "w-8 h-8" : "w-12 h-12"}  transition-all duration-200`} />
          </CustomLink>
      ...
      >
        <div className="flex px-4 justify-between">
          <CustomLink href="/">
            <img src="/images/logo.svg" alt="Logo" className="w-10 h-10" onClick={handleClose} />
          </CustomLink>
