...
const Cleanfits: React.FC<Props> = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [step, setStep] = useState(0);

  const stepperImages = ["/images/works/cleanfits/1.png", "/images/works/cleanfits/cleanfits.png", "/images/works/cleanfits/2.png"];
  ...
  return (
    <>
      <div className="w-full my-8 clean-fits shadow-md rounded h-50vh lg:grid grid-cols-2 gap-6">
        <div className="text-center px-4 md:px-20 pt-8 md:pt-0 md:flex flex-col items-center justify-center h-full xl:px-40 z-10">
          <h2 className="text-2xl text-white font-black">Cleanfits</h2>
        ...
        <div className="overflow-hidden md:block hidden relative">
          <img src="/images/works/cleanfits/cleanfits.png" alt="Cleanfits" className="absolute bottom-0 left-0 -mb-16" />
        </div>
      </div>
