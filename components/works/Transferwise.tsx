...
const Transferwise: React.FC<Props> = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [step, setStep] = useState(0);

  const stepperImages = ["/images/works/transferwise/transferwise.png", "/images/works/transferwise/1.png", "/images/works/transferwise/2.png", "/images/works/transferwise/3.png"];
  ...
  return (
    <>
      <div className="w-full my-8 transferwise shadow-md rounded h-50vh lg:grid grid-cols-2 gap-6">
        <div className="relative overflow-hidden md:block hidden">
          <img src="/images/works/transferwise.png" alt="Unsplash clone app" className="absolute bottom-0 left-0 -mb-16 mx-auto w-full" />
        </div>

        <div className="text-center px-4 md:px-20 pt-8 md:pt-0 md:flex flex-col items-center justify-center h-full xl:px-40 z-10">
          <h2 className="text-2xl text-black font-black">Transferwise clone</h2>
          <p className=" text-black text-lg">A fast, easy, and secure way to pay online, in apps, or in person.</p>
      ...
      >
        ...
        <div className="max-w-2xl w-full bg-bg z-50 mt-20 pb-20 absolute top-0 overflow-scroll no-scroll mb-20 rounded  h-85">
          ...
          <div className="p-6 text-center">
            <h2 className="font-bold text-2xl text-g-100">Transferwise Clone</h2>
            <p className="text-md text-g-75">I cloned the homepage of transferwise.com. I attempted the design and most functionalities present on the website.</p>

            <div className="mx-auto w-full mt-6">
              <CustomLink target="_blank" href="//transferwise.netlify.com/" className="px-3 py-2 gradient rounded-full text-white border-2 hover:shadow">
                Visit site
              </CustomLink>
              <CustomLink target="_blank" href="//github.com/DNature/transferwise">
